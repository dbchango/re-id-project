...
if __name__ == '__main__':
    ...
    output_path = "outputs/multi-input/video_2.avi"
    ...
    for o in Camera(src=source_2, id=1).read_video(model.segment, id_model, 'outputs/multi-input/cam2_detections.csv'):
