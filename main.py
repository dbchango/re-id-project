...
if __name__ == '__main__':
    ...
    for o1, o2 in zip(Camera(src=source_1).read_video(model.segment, id_model, 'outputs/run_1/cam1_detections.csv'), Camera(src=source_2).read_video(model.segment, id_model, 'outputs/run_1/cam2_detections.csv')):
