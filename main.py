...
from utils.Camera_Color import Camera
...
if __name__ == '__main__':
    ...
    output_path = "results/color-RGB/model 2/video_2.avi"
    ...
    for o in Camera(src=source_2, id=1).read_video(model.segment, id_model, 'results/color-RGB/model 2/cam2_detections.csv'):
